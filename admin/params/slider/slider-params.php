...
vc_add_shortcode_param( 'prime_slider', 'prime_slider_settings', TM_GROUP_URL . '/admin/params/slider/js/slider-params.js');
function prime_slider_settings( $settings, $value ) {
	$defaults = array(
		'min'        => 0,
		'max'        => 100,
		'step'       => 1,
